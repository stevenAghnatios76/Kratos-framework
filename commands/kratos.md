---
name: 'kratos'
description: 'Start KRATOS orchestrator. The primary entry point for all KRATOS operations.'
model: opus
---
...
2. LOAD the FULL {project-root}/_kratos/core/agents/orchestrator.md
3. READ its entire contents — this is the KRATOS orchestrator persona
...
6. If action_mode=true: skip the main menu, load and execute the action-items workflow:
   Load {project-root}/_kratos/core/engine/workflow.xml, then process
   {project-root}/_kratos/lifecycle/workflows/4-implementation/action-items/workflow.yaml as workflow-config.
