...
description: 'Check composite review gate status for a story. Use when "check review gate".'
model: sonnet
---
...
3. Pass {project-root}/_gaia/lifecycle/workflows/4-implementation/check-review-gate/workflow.yaml as 'workflow-config'
